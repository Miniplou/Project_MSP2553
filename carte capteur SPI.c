...
void init_USCI( void )
{
    ...
    UCB0CTL0 &= ~( UCCKPH | UCCKPL | UCMSB | UC7BIT | UCMST); //-> UCMST a 0 pour etre en esclave
    UCB0CTL1 |= UCSSEL_2;
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 * Main envois (met dans le buffer) la lettre c en SPI a l'aautre carte
 */
void main( void )
{
    init_BOARD();
